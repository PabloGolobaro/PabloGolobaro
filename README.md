...
- **Backend engineering** — designing and building scalable Go microservices
- **System design & architecture** — applying sound architectural principles to complex domains
- **High-load systems** — building services that perform reliably under pressure
...
- Advanced **distributed systems patterns** — saga orchestration, consensus algorithms, and resilience strategies for large-scale financial systems
...
- **ХабрКарьера:** _[карьера](https://career.habr.com/pablogolobar)_
- **Telegram:** _@PabloGolobar_

---

<sub>Languages: English (professional working proficiency)</sub>
